...
% quaternion
q = [cos(attitude(1)/2)*cos(attitude(2)/2)*cos(attitude(3)/2)+sin(attitude(1)/2)*sin(attitude(2)/2)*sin(attitude(3)/2);
    sin(attitude(1)/2)*cos(attitude(2)/2)*cos(attitude(3)/2)-cos(attitude(1)/2)*sin(attitude(2)/2)*sin(attitude(3)/2);
    cos(attitude(1)/2)*sin(attitude(2)/2)*cos(attitude(3)/2)+sin(attitude(1)/2)*cos(attitude(2)/2)*sin(attitude(3)/2);
    cos(attitude(1)/2)*cos(attitude(2)/2)*sin(attitude(3)/2)-sin(attitude(1)/2)*sin(attitude(2)/2)*cos(attitude(3)/2)];
for i = 1:length(IMU_true)
    ...
    Cbn_q = [q(1)^2+q(2)^2-q(3)^2-q(4)^2, 2*(q(2)*q(3)+q(1)*q(4)), 2*(q(2)*q(4)-q(1)*q(3));
    ...
    q_dot = 1/2*[0, -omega_n_b_b(1), -omega_n_b_b(2), -omega_n_b_b(3);
        omega_n_b_b(1), 0, omega_n_b_b(3), -omega_n_b_b(2);
        omega_n_b_b(2), -omega_n_b_b(3), 0, omega_n_b_b(1);
        omega_n_b_b(3), omega_n_b_b(2), -omega_n_b_b(1), 0]*q;
    
    q = q + q_dot*dt;
    attitude = [atan2(Cbn_q(3, 2), Cbn_q(3, 3));...
        -asin(Cbn_q(3, 1));...
        atan2(Cbn_q(2, 1), Cbn_q(1, 1))];
...
if dir_state
    print('../../../Figure/Q5/latitude_q','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../../Figure/Q5');
if dir_state
    print('../../../Figure/Q5/longitude_q','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../../Figure/Q5');
if dir_state
    print('../../../Figure/Q5/altitude_q','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../../Figure/Q5');
if dir_state
    print('../../../Figure/Q5/velocity_x_q','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../../Figure/Q5');
if dir_state
    print('../../../Figure/Q5/velocity_y_q','-depsc');
else
    fprintf("Ooooooops\n")
end
...
[dir_state, ~, ~] = mkdir('../../../Figure/Q5');
if dir_state
    print('../../../Figure/Q5/velocity_z_q','-depsc');
else
    fprintf("Ooooooops\n")
end
